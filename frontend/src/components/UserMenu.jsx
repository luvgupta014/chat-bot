  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 neon-theme:hover:bg-[#142a18] transition"
        title={user.name}
      >
          <div
            className={`w-9 h-9 flex items-center justify-center font-semibold text-base rounded-full border transition-all duration-300
              ${lightNameBg
                ...
                : 'dark:bg-blue-800 dark:text-white dark:border-blue-700 neon-theme:bg-[#101d12] neon-theme:text-[#39ff14] neon-theme:border-[#39ff14]'}
              shadow-sm`}
          >
        ...
        <span
          className={`text-sm font-medium hidden md:block transition-colors px-2 py-1 rounded-lg ml-1
            ${lightNameBg
              ...
              : 'text-gray-100 dark:text-gray-200 neon-theme:text-[#baffc9] bg-gradient-to-br from-blue-500/10 to-indigo-100/20 dark:from-slate-800/60 dark:to-slate-900/60 neon-theme:bg-[#1a2f1d] border border-transparent'}
          `}
        >
            {user.name}
        </span>
      ...
      {showMenu && (
        <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-800 neon-theme:bg-[#1a2f1d] rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 neon-theme:border-[#39ff14] z-50 py-1">
          ...
          <button
            ...
            className="w-full px-4 py-2 text-left text-sm text-gray-800 dark:text-gray-200 neon-theme:text-[#baffc9] hover:bg-gray-100 dark:hover:bg-slate-700 neon-theme:hover:bg-[#142a18] transition flex items-center gap-2"
          >
          ...
          <button
            ...
            className="w-full px-4 py-2 text-left text-sm text-red-700 dark:text-red-400 neon-theme:text-[#ff4444] hover:bg-red-50 dark:hover:bg-red-900/20 neon-theme:hover:bg-[#142a18] transition flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
